...
// --- 47개 도도부현 실제 지형 굴곡을 반영한 정밀 다각형(Polygon) 데이터셋 ---
const PREFECTURE_DB = [
  { id: 1, ko: "홋카이도", jp: "北海道", region: "홋카이도 지방", specialty: "게, 유제품, 라멘", spot: "삿포로 오도리 공원", 
    geojson: { type: "Polygon", coordinates: [[
      [140.2, 41.4], [139.6, 41.8], [139.3, 42.2], [139.9, 42.9], [140.7, 42.4], [141.5, 42.6], 
      [141.0, 43.5], [139.7, 43.9], [139.5, 44.5], [140.4, 45.3], [141.9, 45.5], [143.0, 45.3], 
      [145.8, 45.4], [145.7, 44.7], [144.9, 43.8], [145.8, 43.3], [144.4, 42.9], [143.2, 42.8], 
      [142.1, 42.0], [143.1, 41.4], [141.1, 41.5], [140.2, 41.4]
    ]] }, mapCoord: {x: 180, y: 35} },
  { id: 2, ko: "아오모리현", jp: "青森県", region: "도호쿠 지방", specialty: "사과, 가을꽁치", spot: "히로사키 성", 
    geojson: { type: "Polygon", coordinates: [[
      [140.0, 41.5], [140.6, 41.3], [140.9, 41.5], [141.4, 41.3], [141.5, 40.8], [141.3, 40.5], 
      [140.6, 40.4], [140.2, 40.7], [139.9, 41.0], [140.0, 41.5]
    ]] }, mapCoord: {x: 145, y: 105} },
  { id: 3, ko: "이와테현", jp: "岩手県", region: "도호쿠 지방", specialty: "모리오카 냉면, 완코소바", spot: "주손지", 
    geojson: { type: "Polygon", coordinates: [[
      [141.0, 40.5], [141.5, 40.5], [142.0, 40.2], [142.1, 39.5], [141.8, 39.0], [141.3, 38.8], 
      [141.0, 39.2], [141.0, 40.5]
    ]] }, mapCoord: {x: 165, y: 120} },
  { id: 4, ko: "미야기현", jp: "宮城県", region: "도호쿠 지방", specialty: "우설구이, 즈다모찌", spot: "마쓰시마", 
    geojson: { type: "Polygon", coordinates: [[
      [141.0, 39.2], [141.3, 38.8], [141.6, 39.0], [141.4, 38.2], [141.0, 37.8], [140.3, 38.2], 
      [140.5, 38.8], [141.0, 39.2]
    ]] }, mapCoord: {x: 160, y: 135} },
  { id: 5, ko: "아키타현", jp: "秋田県", region: "도호쿠 지방", specialty: "키리탄포", spot: "다자와호", 
    geojson: { type: "Polygon", coordinates: [[
      [139.9, 40.5], [140.6, 40.5], [140.7, 39.8], [140.4, 39.2], [139.8, 39.4], [139.7, 40.0], [139.9, 40.5]
  ...
  { id: 7, ko: "후쿠시마현", jp: "福島県", region: "도호쿠 지방", specialty: "라멘, 복숭아", spot: "아이즈와카마쓰 성", 
    geojson: { type: "Polygon", coordinates: [[
      [139.7, 38.0], [140.2, 37.8], [141.0, 37.8], [141.0, 37.0], [139.5, 37.0], [139.7, 38.0]
...
// 실제 지도 형태의 굴곡을 정확하게 캔버스 중앙에 맞춰 렌더링하는 함수
