...
// --- 47개 도도부현 실제 지형 굴곡을 극대화한 초정밀 좌표 데이터셋 ---
const PREFECTURE_DB = [
  { id: 1, ko: "홋카이도", jp: "北海道", region: "홋카이도 지방", specialty: "게, 유제품, 라멘", spot: "삿포로 오도리 공원", 
    geojson: { type: "Polygon", coordinates: [[
      [140.2, 41.4], [139.8, 41.6], [139.3, 42.0], [139.1, 42.5], [139.8, 42.9], [140.4, 42.2], 
      [141.4, 42.6], [141.0, 43.5], [139.6, 43.8], [139.4, 44.4], [140.2, 45.2], [141.8, 45.5], 
      [143.0, 45.3], [145.8, 45.4], [145.7, 44.8], [144.9, 43.8], [145.9, 43.3], [144.4, 42.9], 
      [143.2, 42.8], [142.0, 42.0], [143.1, 41.4], [141.0, 41.5], [140.2, 41.4]
    ]] }, mapCoord: {x: 180, y: 35} },
  { id: 2, ko: "아오모리현", jp: "青森県", region: "도호쿠 지방", specialty: "사과, 가을꽁치", spot: "히로사키 성", 
    geojson: { type: "Polygon", coordinates: [[
      [140.0, 41.5], [140.5, 41.2], [140.9, 41.4], [141.4, 41.3], [141.5, 40.8], [141.3, 40.5], 
      [140.7, 40.4], [140.2, 40.6], [139.8, 40.5], [139.5, 41.0], [140.0, 41.5]
    ]] }, mapCoord: {x: 145, y: 105} },
  { id: 3, ko: "이와테현", jp: "岩手県", region: "도호쿠 지방", specialty: "모리오카 냉면, 완코소바", spot: "주손지", 
    geojson: { type: "Polygon", coordinates: [[
      [141.0, 40.5], [141.5, 40.5], [142.1, 40.3], [142.0, 39.8], [141.8, 39.2], [141.4, 38.8], 
      [141.0, 39.2], [140.8, 39.8], [141.0, 40.5]
    ]] }, mapCoord: {x: 165, y: 120} },
  { id: 4, ko: "미야기현", jp: "宮城県", region: "도호쿠 지방", specialty: "우설구이, 즈다모찌", spot: "마쓰시마", 
    geojson: { type: "Polygon", coordinates: [[
      [141.0, 39.2], [141.4, 38.8], [141.6, 39.0], [141.5, 38.3], [141.3, 38.0], [141.0, 37.8], 
      [140.3, 38.2], [140.5, 38.8], [141.0, 39.2]
    ]] }, mapCoord: {x: 160, y: 135} },
  { id: 5, ko: "아키타현", jp: "秋田県", region: "도호쿠 지방", specialty: "키리탄포", spot: "다자와호", 
    geojson: { type: "Polygon", coordinates: [[
      [139.9, 40.5], [140.6, 40.5], [140.8, 39.8], [140.4, 39.2], [139.8, 39.4], [139.7, 40.0], [139.9, 40.5]
    ]] }, mapCoord: {x: 130, y: 120} },
  { id: 6, ko: "야마가타현", jp: "山形県", region: "도호쿠 지방", specialty: "체리", spot: "자오 온천", 
    geojson: { type: "Polygon", coordinates: [[
      [139.8, 39.2], [140.4, 39.2], [140.5, 38.5], [140.2, 37.8], [139.7, 38.0], [139.9, 38.7], [139.8, 39.2]
    ]] }, mapCoord: {x: 138, y: 135} },
  { id: 7, ko: "후쿠시마현", jp: "福島県", region: "도호쿠 지방", specialty: "라멘, 복숭아", spot: "아이즈와카마쓰 성", 
    geojson: { type: "Polygon", coordinates: [[
      [139.7, 38.0], [140.2, 37.8], [141.0, 37.8], [141.1, 37.3], [140.8, 37.0], [139.5, 37.0], [139.7, 38.0]
    ]] }, mapCoord: {x: 152, y: 150} },
  { id: 8, ko: "이바라키현", jp: "茨城県", region: "간토 지방", specialty: "낫토, 멜론", spot: "가이라쿠엔", 
    geojson: { type: "Polygon", coordinates: [[
      [139.8, 36.8], [140.8, 36.8], [140.7, 36.3], [140.5, 35.8], [139.8, 36.0], [139.8, 36.8]
  ...
  { id: 12, ko: "치바현", jp: "千葉県", region: "간토 지방", specialty: "땅콩", spot: "도쿄 디즈니리조트", 
    geojson: { type: "Polygon", coordinates: [[
      [139.8, 36.0], [140.8, 35.8], [140.5, 35.2], [140.1, 35.0], [139.8, 35.5], [139.8, 36.0]
  ...
  { id: 15, ko: "니가타현", jp: "新潟県", region: "중부 지방", specialty: "고시히카리 쌀", spot: "사도시섬", 
    geojson: { type: "Polygon", coordinates: [[
      [139.3, 38.3], [139.5, 38.0], [139.1, 37.6], [139.3, 37.3], [139.0, 37.0], [138.4, 36.8], 
      [137.8, 37.1], [138.2, 37.7], [138.8, 38.2], [139.3, 38.3]
...
// 캔버스에 좌표들을 완벽하게 스케일링해서 굴곡진 해안선을 그리는 함수
...
if (!mapBtn) {
  ...
  mapBtn.style.cssText = "background:#85586F; margin-bottom:1rem; padding:8px; font-size:0.85rem;";
